...
async def boosty_cookies_jar_async(
...
async def unauthorized_boosty_client(
    ...
    return BoostyAPIClient(session=unauthorized_retry_client, request_delay_seconds=1)
...
async def invalid_auth_boosty_client(
    ...
    return BoostyAPIClient(session=invalid_auth_retry_client, request_delay_seconds=1)
