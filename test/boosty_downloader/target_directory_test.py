...
from boosty_downloader.src.download_manager.download_manager import BoostyDownloadManager
...
from boosty_downloader.src.yaml_configuration.config import Config, DownloadSettings
...
class TestTargetDirectoryConfig(unittest.TestCase):
    ...
    def test_relative_path_config(self):
        ...
        self.assertTrue(download_manager._target_directory.is_absolute())
        self.assertEqual(
            download_manager._target_directory.name,
            'custom-downloads'
        )
    ...
    def test_absolute_path_config(self):
        ...
        self.assertTrue(download_manager._target_directory.is_absolute())
        self.assertEqual(
            download_manager._target_directory,
    ...
    def test_config_integration(self):
        ...
        self.assertEqual(download_settings.target_directory, Path('./test-relative'))
        ...
        download_settings = DownloadSettings.model_validate(config_data['downloading_settings'])
        self.assertEqual(download_settings.target_directory, Path(abs_path))
