...
class DownloadSinglePostUseCase:
    ...
    async def download_boosty_video(
        ...
        dl_config = DownloadFileConfig(
            ...
            on_status_update=lambda _: None,  # No-op for now
        )
    ...
    async def download_external_videos(
        ...
        # For src= attribute, we need to ensure the path is relative and sanitized
        # AND HAVE NO SPACES IN THE PATH
    ...
    async def download_image(self, image: PostDataChunkImage) -> Path:
        ...
        # Here you should implement the actual downloading logic
